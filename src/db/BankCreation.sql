...
GRANT INSERT, SELECT, UPDATE, DELETE ON account TO bank_connection;
GRANT INSERT, SELECT, UPDATE, DELETE ON account_employees_jt TO bank_connection;
GRANT INSERT, SELECT, UPDATE, DELETE ON account_ownership_jt TO bank_connection;
GRANT INSERT, SELECT, UPDATE, DELETE ON account_request TO bank_connection;
GRANT INSERT, SELECT, UPDATE, DELETE ON account_request_users TO bank_connection;
GRANT INSERT, SELECT, UPDATE, DELETE ON account_transaction TO bank_connection;
GRANT INSERT, SELECT, UPDATE, DELETE ON account_transaction_status TO bank_connection;
GRANT INSERT, SELECT, UPDATE, DELETE ON account_transaction_type TO bank_connection;
GRANT INSERT, SELECT, UPDATE, DELETE ON account_type TO bank_connection;
GRANT INSERT, SELECT, UPDATE, DELETE ON address TO bank_connection;
GRANT INSERT, SELECT, UPDATE, DELETE ON associated_people_jt TO bank_connection;
GRANT INSERT, SELECT, UPDATE, DELETE ON city TO bank_connection;
GRANT INSERT, SELECT, UPDATE, DELETE ON email TO bank_connection;
GRANT INSERT, SELECT, UPDATE, DELETE ON permission_rank_jt TO bank_connection;
GRANT INSERT, SELECT, UPDATE, DELETE ON permission_rank_label TO bank_connection;
GRANT INSERT, SELECT, UPDATE, DELETE ON person TO bank_connection;
GRANT INSERT, SELECT, UPDATE, DELETE ON person_standing TO bank_connection;
GRANT INSERT, SELECT, UPDATE, DELETE ON phone_number TO bank_connection;
COMMIT;
